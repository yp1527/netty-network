...
public final class PlatformDependent {
    ...
    private static int hashCodeAsciiCompute(CharSequence value, int offset, int hash) {
        ...
        return hash * PlatformDependent0.HASH_CODE_C1 +
                // Low order int
                hashCodeAsciiSanitizeInt(value, offset) * PlatformDependent0.HASH_CODE_C2 +
                // High order int
    ...
    public static int hashCodeAscii(CharSequence bytes) {
        int hash = PlatformDependent0.HASH_CODE_ASCII_SEED;
        ...
        switch(remainingBytes) {
            case 7:
                return ((hash * PlatformDependent0.HASH_CODE_C1 + hashCodeAsciiSanitizsByte(bytes.charAt(0)))
                              * PlatformDependent0.HASH_CODE_C2 + hashCodeAsciiSanitizeShort(bytes, 1))
                              * PlatformDependent0.HASH_CODE_C1 + hashCodeAsciiSanitizeInt(bytes, 3);
            case 6:
                return (hash * PlatformDependent0.HASH_CODE_C1 + hashCodeAsciiSanitizeShort(bytes, 0))
                             * PlatformDependent0.HASH_CODE_C2 + hashCodeAsciiSanitizeInt(bytes, 2);
            case 5:
                return (hash * PlatformDependent0.HASH_CODE_C1 + hashCodeAsciiSanitizsByte(bytes.charAt(0)))
                             * PlatformDependent0.HASH_CODE_C2 + hashCodeAsciiSanitizeInt(bytes, 1);
            case 4:
                return hash * PlatformDependent0.HASH_CODE_C1 + hashCodeAsciiSanitizeInt(bytes, 0);
            case 3:
                return (hash * PlatformDependent0.HASH_CODE_C1 + hashCodeAsciiSanitizsByte(bytes.charAt(0)))
                             * PlatformDependent0.HASH_CODE_C2 + hashCodeAsciiSanitizeShort(bytes, 1);
            case 2:
    ...
    static int hashCodeAsciiSafe(byte[] bytes, int startPos, int length) {
        ...
        switch(remainingBytes) {
        case 7:
            return ((hash * PlatformDependent0.HASH_CODE_C1 + PlatformDependent0.hashCodeAsciiSanitize(bytes[startPos]))
                          * PlatformDependent0.HASH_CODE_C2 + PlatformDependent0.hashCodeAsciiSanitize(getShortSafe(bytes, startPos + 1)))
                          * PlatformDependent0.HASH_CODE_C1 + PlatformDependent0.hashCodeAsciiSanitize(getIntSafe(bytes, startPos + 3));
        case 6:
            return (hash * PlatformDependent0.HASH_CODE_C1 + PlatformDependent0.hashCodeAsciiSanitize(getShortSafe(bytes, startPos)))
                         * PlatformDependent0.HASH_CODE_C2 + PlatformDependent0.hashCodeAsciiSanitize(getIntSafe(bytes, startPos + 2));
        case 5:
            return (hash * PlatformDependent0.HASH_CODE_C1 + PlatformDependent0.hashCodeAsciiSanitize(bytes[startPos]))
                         * PlatformDependent0.HASH_CODE_C2 + PlatformDependent0.hashCodeAsciiSanitize(getIntSafe(bytes, startPos + 1));
        case 4:
            return hash * PlatformDependent0.HASH_CODE_C1 + PlatformDependent0.hashCodeAsciiSanitize(getIntSafe(bytes, startPos));
        case 3:
            return (hash * PlatformDependent0.HASH_CODE_C1 + PlatformDependent0.hashCodeAsciiSanitize(bytes[startPos]))
                         * PlatformDependent0.HASH_CODE_C2 + PlatformDependent0.hashCodeAsciiSanitize(getShortSafe(bytes, startPos + 1));
        case 2:
